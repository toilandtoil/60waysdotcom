<?php
session_start(); // session_start gives you this application's global vars created from the beginning.
...
$resolutions   = array(1382, 1025, 641, 481); // the resolution break-points to use (screen widths, in pixels)
